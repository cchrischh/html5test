	...
	<body onload='startTest();'>
		...
		<div class='column'>
			...
			<div id='explaination'>
				...
				<p> 
					May 28, 2010 - version 1.0
				</p>

				<div class='credits'>
					<p> 
						HTML5 test is created by Niels Leenheer.<br>
		...
		<!--
			...
			test.prototype = {
				suites: [ 
					{ title: null, sections: [ testParsing, testCanvas, testVideo, testAudio, testDevice, testElements, testForm, testInteraction, testMicrodata, testOffline ] },
			...
			testParsing.prototype = {
				...
				t4: function() {
					this.section.setExplaination('HTML5 defines rules for embedding SVG and MathML inside a regular HTML document. Support for SVG and MathML are not required though, so bonus points are awarded if your browser supports embedding these two techologies.')
				},
			...
			testOffline.prototype = {
				...
				t2: function() {
					this.section.setItem({
						...
						url:	'http://www.w3.org/TR/html5/webappapis.html#dom-navigator-registerprotocolhandler',
